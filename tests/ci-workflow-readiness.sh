...
assert_contains .github/workflows/ci.yml "timeout-minutes: 2"
assert_contains .github/workflows/ci.yml "AppSettingsTests"
assert_contains .github/workflows/ci.yml "KillSafetyTests"
assert_contains .github/workflows/ci.yml "RefreshSchedulerTests"
assert_not_contains .github/workflows/ci.yml "PTK_CI_WINDOWSERVER_TEST_SKIP"
assert_not_contains .github/workflows/ci.yml "PTK_CI_PROCESS_TEST_SKIP"
