...
assert_contains .github/workflows/ci.yml "ProcessRunnerTests"
assert_contains .github/workflows/ci.yml "systemServiceCommandRunnerReturnsPromptlyAfterTimeoutAndReapsWithOneWaiter"
