...
assert_contains README.md "CODEX_HOME"
...
assert_contains README.ko.md "로컬 개발 포트를 안전하게 확인하고 정리하는 네이티브 macOS 메뉴 막대 유틸리티"
...
assert_contains README.ko.md "CODEX_HOME"
...
assert_contains .github/workflows/ci.yml "scripts/package-release.sh 0.0.0 0"
