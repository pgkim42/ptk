...
[{"draft":true,"tag_name":"v0.1.0","published_at":null,"assets":[]}]
EOF
write_readmes none
PTK_RELEASE_FIXTURE="$FIXTURE_ROOT/draft-only.json" run_check

cat > "$FIXTURE_ROOT/public.json" <<'EOF'
[{"draft":false,"tag_name":"v0.1.0","published_at":"2026-08-09T00:00:00Z","assets":[]}]
EOF
write_readmes none
...
[
  {"draft":false,"tag_name":"v0.1.0","published_at":"2026-08-09T00:00:00Z","assets":[{"name":"PTK-macos-0.1.0-unsigned.dmg"},{"name":"PTK-macos-0.1.0-unsigned.zip"}]},
  {"draft":false,"tag_name":"v0.0.1","published_at":"2026-07-01T00:00:00Z","assets":[{"name":"PTK-macos-0.0.1-unsigned.dmg"},{"name":"PTK-macos-0.0.1-unsigned.zip"}]}
]
EOF
write_readmes 0.0.1
